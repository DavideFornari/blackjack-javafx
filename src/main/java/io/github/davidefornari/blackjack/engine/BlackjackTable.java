 ...
 * an Ace or a ten-value card, the hole card is peeked immediately. If that is a dealer
 * natural, the round ends right there — a player blackjack pushes, anything else loses
 * — instead of letting players hit, double or split into a hand that was already lost.
 */
